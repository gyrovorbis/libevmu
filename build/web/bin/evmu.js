...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'bin/evmu.data';
    var REMOTE_PACKAGE_BASE = 'evmu.data';
...
Module['FS_createPath']('/', 'roms', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_bin/evmu.data');

    };
    Module['addRunDependency']('datafile_bin/evmu.data');
 ...
 loadPackage({"files": [{"filename": "/roms/minigame.dci", "start": 0, "end": 65568, "audio": 0}, {"filename": "/roms/minigame.vmi", "start": 65568, "end": 65676, "audio": 0}, {"filename": "/roms/minigame.vms", "start": 65676, "end": 131212, "audio": 0}], "remote_package_size": 131212, "package_uuid": "a990b37a-505a-4edf-a3ef-f19aa3f179e9"});
