#ifndef EVMU_MEMORY_BUS_H
#define EVMU_MEMORY_BUS_H
...
typedef enum EVMU_MEMORY_ACCESS_TYPE {
...
typedef enum EVMU_MEMORY_EXT_SOURCE {
    EVMU_MEMORY_EXT_ROM,
...
EVMU_API evmuMemorySegmentWrite(const EVMUMemory* pMem, EVMU_MEMORY_SEGMENT_TYPE segment, EVMU_MEMORY_BANK bank, EvmuAddress baseAddress, const EvmuWord* pData, EvmuSize* pBytes, EVMU_MEMORY_TYPE accessType);

// Generic read/write over only ROM/Flash EXT/Imem sources
EVMU_API evmuMemoryExtRead(const EvmuMemory* pMem, EvmuAddress baseAddres, EvmuWord* pData, EvmuSize* pBytes, EVMU_MEMORY_ACCESS_TYPE accessType);
...
EVMU_API evmuMemoryRamRead(const EvmuMemory* pMem, EVMU_RAM_BANK bank, EvmuAddress baseAddress, EvmuWord* pData, EvmuSize* pBytes);
EVMU_API evmuMemoryRamWrite(const EvmuMemory* pMem, EVMU_RAM_BANK bank, EvmuAddress baseAddress, const EvmuWord* pData, EvmuSize* pBytes);
