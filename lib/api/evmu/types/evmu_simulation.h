...
#define EVMU_SIMULATION(instance)                   (GBL_TYPE_CAST_INSTANCE_PREFIX  (instance,  EVMU_SIMULATION))
#define EVMU_SIMULATION_CHECK(instance)             (GBL_TYPE_CHECK_INSTANCE_PREFIX (instance,  EVMU_SIMULATION))
#define EVMU_SIMULATION_CLASS(klass)                (GBL_TYPE_CAST_CLASS_PREFIX     (klass,     EVMU_SIMULATION))
#define EVMU_SIMULATION_CLASS_CHECK(klass)          (GBL_TYPE_CHECK_CLASS_PREFIX    (klass,     EVMU_SIMULATION))
#define EVMU_SIMULATION_GET_CLASS(instance)         (GBL_TYPE_CAST_GET_CLASS_PREFIX (instance,  EVMU_SIMULATION))
