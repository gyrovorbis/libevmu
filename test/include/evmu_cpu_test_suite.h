...
#define EVMU_CPU_TEST_SUITE_TYPE                (GBL_TYPEID(EvmuCpuTestSuite))
#define EVMU_CPU_TEST_SUITE(instance)           (GBL_CAST(instannce, EvmuCpuTestSuite))
#define EVMU_CPU_TEST_SUITE_CLASS(klass)        (GBL_CLASS_CAST(klass, EvmuCpuTestSuite))
#define EVMU_CPU_TEST_SUITE_GET_CLASS(instance) (GBL_CLASSOF(instance, EvmuCpuTestSuite))
